...
export const MESSAGES = {
  ...
  bad_animation: ['That animation is broken', 'Анимация испорчена'],
  empty_animation: ['Add at least one key to the animation', 'Добавь в анимацию хотя бы один ключ'],
  too_many_animations: ['You have 200 animations: delete some first', 'У тебя уже 200 анимаций: удали лишние'],
  no_animation: ['Animation not found', 'Анимация не найдена'],
  ...
  payments_down: ["The payment service didn't answer, try again in a minute", 'Платёжный сервис не ответил, попробуй через минуту'],
  bad_signature: ['Bad signature', 'Неверная подпись'],
  bad_amount: ['Amount does not match', 'Сумма не совпадает'],
  no_quest: ['No such quest today', 'Сегодня такого задания нет'],
  quest_not_done: ["This quest isn't finished yet", 'Задание ещё не выполнено'],
  no_pass: ['Gamepass not found', 'Геймпасс не найден'],
  bad_price: ['Price: 1 to 100000 pieces', 'Цена: от 1 до 100000 кусочков'],
  too_many_passes: ['A place can have up to 30 gamepasses', 'У плейса может быть до 30 геймпассов'],
  ticket_short: ['Write a subject and a few words about the problem', 'Напиши тему и пару слов о проблеме'],
  ticket_contact: ['Leave a contact so we can answer (email or Telegram)', 'Оставь контакт, чтобы мы могли ответить (почта или Telegram)'],
  too_many_tickets: ['You already have 5 open requests: wait for an answer', 'У тебя уже 5 открытых обращений: дождись ответа'],
  update_required: ['A new Meltiew is out ({v}). Please update the app.', 'Вышла новая версия Meltiew ({v}). Обнови приложение.'],
  edited_elsewhere: ['{by} saved a newer version of this place. Save over it anyway?', '{by} сохранил более новую версию плейса. Всё равно сохранить поверх?'],
  no_community: ['That community does not exist', 'Такого сообщества нет'],
  bad_community_name: ['Pick a name of 3 to 40 characters, without rude words', 'Название от 3 до 40 символов и без грубых слов'],
  community_name_taken: ['That name is taken', 'Это название уже занято'],
  too_many_communities: ['You can own up to 5 communities', 'Можно владеть максимум 5 сообществами'],
  too_many_joined: ['You are in 50 communities already', 'Ты уже в 50 сообществах'],
  owner_cannot_leave: ['The owner cannot leave. Delete the community instead.', 'Владелец не может выйти. Вместо этого удали сообщество.'],
  community_banned: ['You were banned from this community', 'Тебя забанили в этом сообществе'],
  cannot_post: ['You cannot write in this channel', 'В этот канал тебе писать нельзя'],
  chat_age: ['Chat opens at 13', 'Чат доступен с 13 лет'],
  bad_rank: ['The rank must be between 2 and 254 and lower than yours', 'Ранг от 2 до 254 и ниже твоего'],
  too_many_roles: ['Up to 12 roles', 'Максимум 12 ролей'],
  too_many_channels: ['Up to 15 channels', 'Максимум 15 каналов'],
  last_channel: ['A community needs at least one channel', 'В сообществе должен остаться хотя бы один канал'],
  no_member: ['Not a member', 'Такого участника нет'],
  no_role: ['No such role', 'Такой роли нет'],
  no_channel: ['No such channel', 'Такого канала нет'],
  no_message: ['No such message', 'Такого сообщения нет'],
  empty_message: ['Write something first', 'Сначала напиши что-нибудь'],
